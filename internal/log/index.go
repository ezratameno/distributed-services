...
// index defines our index file, which comprises a persisted file and a memorymapped file.
// The size tells us the size of the index and where to write the next
...
func newIndex(f *os.File, c Config) (*index, error) {
	...
	idx.mmap, err = gommap.Map(idx.file.Fd(), gommap.PROT_READ|gommap.PROT_WRITE,
		gommap.MAP_SHARED)
	if err != nil {
		return nil, err
	}
