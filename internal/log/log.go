...
import (
	...
	api "github.com/ezratameno/distributed-services/api/v1"
)
...
// Build a Log • 47
// reasons. The first reason is to satisfy the io.Reader interface so we can pass it
...
// newSegment(off int64) creates a new segment, appends that segment to the log’s
